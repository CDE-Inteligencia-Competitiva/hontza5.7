<table class="table_node_view">
    ...
    <tr class="tr_node_view">     
            <td class="td_label_node_view"><b>And values</b>:&nbsp;</td>
            <td class="td_value_node_view"><b>And1 title</b><?php print hontza_get_and_rss($node,'arg1title');?></td>
    </tr> 
    ...
    <?php if(hontza_is_filter($node)==0):?>
    <tr class="tr_node_view">     
    ...
    <?php if(hontza_is_filter($node)==1):?>
    <tr class="tr_node_view">     
            <td class="td_label_node_view"><b>RSS sources</b>:&nbsp;</td>
            <td class="td_value_node_view"><?php print hontza_get_url_rss($node,'arg1title');?>      
            </td>
    </tr>  
    <tr class="tr_node_view">     
            <td class="td_label_node_view"><b>Filter</b>:&nbsp;</td>
            <td class="td_value_node_view"><b>Title:   </b><?php print hontza_get_and_rss($node,'arg1title');?>
            <br><b>Description:   </b><?php print hontza_get_and_rss($node,'arg1description');?>
            <br><b>Link:   </b><?php print hontza_get_and_rss($node,'arg1link');?><br>
            <img src="/hontza/sites/default/files/and1.png" width="100%"" align="center"/>
            <br><b>Title:   </b><?php print hontza_get_and_rss($node,'arg2title');?>
            <br><b>Description:   </b><?php print hontza_get_and_rss($node,'arg2description');?>
            <br><b>Link:   </b><?php print hontza_get_and_rss($node,'arg2link');?>
            <br>
            <img src="/hontza/sites/default/files/and1.png" width="100%"" align="center"/>
            <br>
            <b>Title:   </b><?php print hontza_get_and_rss($node,'arg3title');?>
            <br><b>Description:   </b><?php print hontza_get_and_rss($node,'arg3description');?>
            <br><b>Link:   </b><?php print hontza_get_and_rss($node,'arg3link');?>
            <br>
            <img src="/hontza/sites/default/files/OR.png" width="100%"" align="center"/>
            <br>
            <b>Title:   </b><?php print hontza_get_or_rss($node,'ortitle');?>
            <br><b>Description:   </b><?php print hontza_get_or_rss($node,'ordescription');?>
            <br><b>Link:   </b><?php print hontza_get_or_rss($node,'orlink');?>         
            <br>
            <img src="/hontza/sites/default/files/NOT.png" width="100%"" align="center"/>
            <br><b>Title:   </b><?php print hontza_get_not_rss($node,'nottitle');?>
            <br><b>Description:   </b><?php print hontza_get_not_rss($node,'notdescription');?>
            <br><b>Link:   </b><?php print hontza_get_not_rss($node,'notlink');?>
           </td>
    </tr>
