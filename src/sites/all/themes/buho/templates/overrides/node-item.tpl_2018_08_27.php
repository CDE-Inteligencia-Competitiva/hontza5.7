...
<div id="node-<?php print $node->nid; ?>" class="node<?php if ($sticky) { print ' sticky'; } ?><?php if (!$status) { print ' node-unpublished'; } ?><?php print my_class_primera_noticia($node,$page);?>">
  ...
  <div id="flagtitulo">
      ...
      <div class="f-titulo"  title="<?php print_r(red_funciones_get_node_vista_compacta_description($node)); ?>"><h5><b><?php print l(red_solr_inc_resaltar_termino_busqueda(htmlkarakter($title),1));?></b></h5></div>
        <?php else:?>
            <div class="f-titulo"  title="<?php print_r(red_funciones_get_node_vista_compacta_description($node)); ?>"><h2><?php print l(red_solr_inc_resaltar_termino_busqueda(htmlkarakter($title),1),$node_url,$title_link_param, array('attributes'=> array('title'=>'prueba')));?></h2></div>
        <?php endif;?>
      <?php else:?>
    
      <div class="f-titulo" title="<?php print_r(red_funciones_get_node_vista_compacta_description($node)); ?>"><h2><?php print l(red_solr_inc_resaltar_termino_busqueda(htmlkarakter($title),1),$node_url,$title_link_param);?></h2></div>
      <?php endif;?>
  ...
  item vista compacta begiratu replika bat egiteko!!
  
  array('attributes'=> array('title'=>red_funciones_get_node_vista_compacta_description($node)))
  title="<?php //print $tit;?>" 
