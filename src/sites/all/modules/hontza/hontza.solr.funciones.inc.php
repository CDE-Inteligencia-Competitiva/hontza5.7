...
function hontza_solr_funciones_get_bookmark_ini($is_solr){
  ...
  if(hontza_boletin_automatizado_is_activado()){       
    $html[]='<div style="'.$style.'">';
      $html[]=l(my_get_icono_action('pdf', t('Get pdf'),''),'hontza_solr/get_pdf_bookmark_multiple_mode',array('html'=>TRUE,'attributes'=>array('id'=>'id_get_pdf_bookmark_multiple_mode','class'=>'a_class_bookmark_multiple_mode')));    
      $html[]='</div>';
...
function hontza_solr_funciones_bookmark_multiple_mode_callback(){
   ...
   ,'validar','rechazar','reclasificar_tipo_fuente','unselect_report','pdf');
   ...
   if(!empty($node_id_array)){
        ...
        //intelsat-2016            
            ...
            $html.=hontza_solr_search_get_pdf($node_id_array,$url_return,$is_return,$title,$is_solr);
