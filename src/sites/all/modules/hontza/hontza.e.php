...
function hontza_define_filtros_editing_canales_rss(){
  ...
  $form_state['yql_obj']=new stdClass();
    //Filtro 1
    if($_REQUEST['url']){
      $filtros['url']=$_REQUEST['url'];
    }
    //Filtro 2
    if($_REQUEST['regular']){
      $filtros['regular']=$_REQUEST['regular'];
    }
    if($_REQUEST['arg1title']){
      $filtros['arg1title']=$_REQUEST['arg1title'];
    }
    if($_REQUEST['arg1description']){
      $filtros['arg1description']=$_REQUEST['arg1description'];
    }
    if($_REQUEST['arg1link']){
      $filtros['arg1link']=$_REQUEST['arg1link'];
    }
    if($_REQUEST['arg2title']){
      $filtros['arg2title']=$_REQUEST['arg2title'];
    }
    if($_REQUEST['arg2description']){
      $filtros['arg2description']=$_REQUEST['arg2description'];
    }
    if($_REQUEST['arg2link']){
      $filtros['arg2link']=$_REQUEST['arg2link'];
    }
    if($_REQUEST['arg3title']){
      $filtros['arg3title']=$_REQUEST['arg3title'];
    }
    if($_REQUEST['arg3description']){
      $filtros['arg3description']=$_REQUEST['arg3description'];
    }
    if($_REQUEST['arg3link']){
      $filtros['arg3link']=$_REQUEST['arg3link'];
    }
    //Filtro 3
    if($_REQUEST['ortitle']){
      $filtros['ortitle']=$_REQUEST['ortitle'];
    }
    if($_REQUEST['ordescription']){
      $filtros['ordescription']=$_REQUEST['ordescription'];
    }
    if($_REQUEST['orlink']){
      $filtros['orlink']=$_REQUEST['orlink'];
    }
    if($_REQUEST['nottitle']){
      $filtros['nottitle']=$_REQUEST['nottitle'];
    }
    if($_REQUEST['notdescription']){
      $filtros['notdescription']=$_REQUEST['notdescription'];
    }
    if($_REQUEST['notlink']){
      $filtros['notlink']=$_REQUEST['notlink'];
    }
