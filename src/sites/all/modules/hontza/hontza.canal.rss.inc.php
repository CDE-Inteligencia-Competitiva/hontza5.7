...
function hontza_canal_rss_get_logos_apis($powered=''){
    ...
    if(hontza_canal_rss_is_activado_logos_apis()){
     ...
     //   //$html[]=hontza_canal_rss_get_kimonolabs_logo();        
        $html[]=hontza_canal_rss_get_hound_logo();
        $html[]=hontza_canal_rss_get_hontza_filtro_logo();
        if(hontza_is_user_anonimo()){
...
//intelsat-2015
function hontza_canal_rss_get_hound_logo(){
    global $base_url;
    $html=array();
    $html[]='<div style="float:left;padding-left:10px;">';
    $img='<img src="'.$base_url.'/sites/default/files/logo_Hound3.png'.'" height="25"/>';
    $html[]=l($img,'http://www.hontza.es/hound/',array('attributes'=>array('target'=>'_blank'),'absolute'=>true,'html'=>true));
    $html[]='</div>';
    return implode('',$html);
}
//intelsat-2015
function hontza_canal_rss_get_hontza_filtro_logo(){
    global $base_url;
    $html=array();
    $html[]='<div style="float:left;padding-left:10px;">';
    $img='<img src="'.$base_url.'/sites/default/files/logo_Hontza-filtro-RSS.png'.'" height="25"/>';
    $html[]=l($img,'http://www.hontza.es/',array('attributes'=>array('target'=>'_blank'),'absolute'=>true,'html'=>true));
    $html[]='</div>';
    return implode('',$html);
}
//intelsat-2015
function hontza_canal_rss_get_kimonolabs_logo(){
    ...
    $html[]=l($img,'https://www.kimonolabs.com/',array('attributes'=>array('target'=>'_blank'),'absolute'=>true,'html'=>true));
    $html[]='</div>';
    return implode('',$html);
}
//intelsat-2015
