...
class MCAPI {
    ...
    * @param array $type_opts optional - 
    ...
    function campaignCreate($type, $options, $content, $segment_opts=NULL, $type_opts=NULL) {
       ...
       // file_put_contents('/var/www/hontza3/google_sheet/mailchimp2.txt', $params["content"]);
    ...
    */
    ...
    function callServer($method, $params) {
        ...
        ob_start();
        $this->secure = true;//joseba2018 $this->secure la conexion no era segura, entonces iba a conexion no es segura a la segundo 

        //file_put_contents('/var/www/hontza3/google_sheet/mailchimp4.txt', $this->secure);
        if ($this->secure){
        ...
        file_put_contents('/var/www/hontza3/google_sheet/mailchimp3.txt', $resexponse);
